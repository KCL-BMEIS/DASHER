...
$AP = $settings.Get_Item("anon_project")
...
#curl in widnows 10, but http not supported! Invoke-WebRequest>
...
$root_path = "$volume_path\archive1\$HC\arc001\ZZZSpine\"
...
$root_path = "$volume_path\archive2\${AP}\arc001\TestSession\"
if(Test-Path $root_path){
