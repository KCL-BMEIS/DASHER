...
public final class ProtocolReader {
    ...
    private static final String MODALATIES = getLineFromProtocol(PROTOCOL_FILE, "Modality");
    private static final String MODELS = getLineFromProtocol(PROTOCOL_FILE, "ModelName");
    ...
    private static final String getLineFromProtocol(final String path, final String tag) {
        try {
            File initialFile = new java.io.File(path);
            InputStream in = new FileInputStream(initialFile);
            if (null == in) {
   ...
   public static String getModalaties() {
        return MODALATIES;
    }
